...
restaurants = Restaurant.create([
    ...
    {name: 'Arpège', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "https://www.alain-passard.com/en/"},
    {name: 'Alain Ducasse', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "https://www.ducasse-paris.com/en"},
    ...
    {name: 'Le Cinq', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "https://www.restaurant-lecinq.com/en/"},
    {name: 'Pierre Gagnaire', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "https://www.pierre-gagnaire.com/"},
    {name: 'Astrance', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "https://www.astrancerestaurant.com/"},
    {name: 'Le Pré Catelan', city_id: City.find_by(name: 'Paris').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "http://restaurant.leprecatelan.com/"},
    {name: 'Régis et Jacques Marcon', city_id: City.find_by(name: 'Saint-Bonnet-le-Froid').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "http://www.regismarcon.fr/"},
    {name: 'La Vague d\'Or', city_id: City.find_by(name: 'Saint-Tropez').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "http://www.vaguedor.com/en/"},
    ...
    {name: 'L\'Atelier de Joël Robuchon', city_id: City.find_by(name: 'Hong Kong').id , cuisine_id: Cuisine.find_by(name: 'French').id, website_url: "http://www.robuchon.hk/"},
    ...
    {name: 'Da Vittorio', city_id: City.find_by(name: 'Brusaporto').id , cuisine_id: Cuisine.find_by(name: 'Italian').id, website_url: "https://www.davittorio.com/"},
    ...
    {name: 'Uliassi', city_id: City.find_by(name: 'Senigallia').id , cuisine_id: Cuisine.find_by(name: 'Italian').id, website_url: "http://www.uliassi.it/"},
    ...
    {name: 'Sushi Miyakawa', city_id: City.find_by(name: 'Hokkaido').id , cuisine_id: Cuisine.find_by(name: 'Japanese').id, website_url: "http://www.sushi-miyakawa.com/"},
    ...
    {name: 'Hajime', city_id: City.find_by(name: 'Osaka').id , cuisine_id: Cuisine.find_by(name: 'Japanese').id, website_url: "http://www.hajime-artistes.com/"},
    ...
    {name: 'Frantzén', city_id: City.find_by(name: 'Stockholm').id , cuisine_id: Cuisine.find_by(name: 'Japanese').id, website_url: "http://www.restaurantfrantzen.com/"},
    ...
    {name: 'Schloss Schauenstein', city_id: City.find_by(name: "Fürstenau").id , cuisine_id: Cuisine.find_by(name: 'Swiss').id, website_url: "http://www.schauenstein.ch/restaurant"},
    ...
    {name: 'Masa', city_id: City.find_by(name: 'New York City').id , cuisine_id: Cuisine.find_by(name: 'Japanese').id, website_url: "http://www.masanyc.com/"},
