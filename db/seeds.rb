...
cities = City.create([{name: 'Los Angeles'}, {name: 'New York City'}, {name: 'Barcelona'}, {name: 'Paris'}, {name: 'Tokyo'}, {name: 'Hong Kong'}, {name: 'Mexico City'}, {name: 'Cape Town'}])
...
restaurants = Restaurant.create([
    ...
    {name: '', city_id: City.find_by(name: 'Hong Kong').id, cuisine_id: Cuisine.find_by(name: 'Chinese').id},
    {name: '', city_id: City.find_by(name: 'Hong Kong').id, cuisine_id: Cuisine.find_by(name: 'Chinese').id},
    {name: '', city_id: City.find_by(name: 'Hong Kong').id, cuisine_id: Cuisine.find_by(name: 'Chinese').id},
    {name: '', city_id: City.find_by(name: 'Hong Kong').id, cuisine_id: Cuisine.find_by(name: 'Chinese').id},
    {name: '', city_id: City.find_by(name: 'Hong Kong').id, cuisine_id: Cuisine.find_by(name: 'Chinese').id},
    {name: '', city_id: City.find_by(name: 'Mexico City').id, cuisine_id: Cuisine.find_by(name: 'Mexican').id},
    {name: '', city_id: City.find_by(name: 'Mexico City').id, cuisine_id: Cuisine.find_by(name: 'Mexican').id},
    {name: '', city_id: City.find_by(name: 'Mexico City').id, cuisine_id: Cuisine.find_by(name: 'Mexican').id},
    {name: '', city_id: City.find_by(name: 'Mexico City').id, cuisine_id: Cuisine.find_by(name: 'Mexican').id},
    {name: '', city_id: City.find_by(name: 'Mexico City').id, cuisine_id: Cuisine.find_by(name: 'Mexican').id},
    {name: '', city_id: City.find_by(name: 'Cape Town').id, cuisine_id: Cuisine.find_by(name: '').id},
    {name: '', city_id: City.find_by(name: 'Cape Town').id, cuisine_id: Cuisine.find_by(name: '').id},
    {name: '', city_id: City.find_by(name: 'Cape Town').id, cuisine_id: Cuisine.find_by(name: '').id},
    {name: '', city_id: City.find_by(name: 'Cape Town').id, cuisine_id: Cuisine.find_by(name: '').id},
    {name: '', city_id: City.find_by(name: 'Cape Town').id, cuisine_id: Cuisine.find_by(name: '').id}
